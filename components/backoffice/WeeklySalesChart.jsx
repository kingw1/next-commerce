                ...
                <button
                  ...
                  className={
                    chartToDisplay == tab.type
                      ? "inline-block p-4 text-orange-600 hover:text-orange-400 rounded-t-lg active dark:bg-orange-800 dark:text-orange-500 border-b border-orange-700"
                      : "inline-block p-4 text-gray-200 hover:text-gray-400 rounded-t-lg active dark:bg-gray-800 dark:text-gray-500"
                  }
                >
                  {tab.title}
                </button>
